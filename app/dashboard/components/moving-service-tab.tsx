import { Truck, BrushCleaning, Clock, User, Phone, MapPin } from "lucide-react";
import {
  AllServiceHistory,
  ServiceStatus,
  StatusConfigItem,
...
type MovingHistoryProps = {
  movingHistory: AllServiceHistory[];
  activeSubTab: string;
};

function MovingServiceTab({ movingHistory, activeSubTab }: MovingHistoryProps) {
  return (
    <div className="space-y-4">
      {activeSubTab === "moving" &&
        movingHistory.map(service => {
...
export default MovingServiceTab;
